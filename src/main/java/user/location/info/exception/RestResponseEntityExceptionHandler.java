package user.location.info.exception;
...
import user.location.info.validation.ValidationFailure;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		return handleExceptionInternal(ex, new ValidationFailureResponse(validationErrors), headers, status, request);
	}
